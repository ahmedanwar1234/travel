...
const Hero = () => {
  return (
    <section className="  max-container padding-container items-start flex flex-col gap-20 py-10 pb-32 md:gap-28  lg:py-20 xl:flex-row ">
        ...
        <div className=" relative z-20 flex  w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8 ">
          <div className=" flex flex-col">
            ...
            <div className=" flexBetween">
              ...
              <div className=" flex flex-col">
                <p className=" regular-16 text-gray-20 block">Ekevation</p>
